...
#' @param x string with REDCap logic
#'
#' @return Intermediate code with R missingness syntax that can be evaluated after further modifications into R expression trees
#'
#'@include data_types.R
#'
...
#'
#' @title Replace spaces with tabs in code files
#'
#' @description Format code by replacing spaces with tabs to allow for block indentation
#'
...
#'
#' @return Intermediate code with R date syntax that can be evaluated after further modifications into R expression trees
#'
...
#'
#' These logic has to be transformed into the appropriate analytical tool's DSL for consistent data munging and analysis.
#'
...
#'
#' @return a string with containing R code (token) that can be parsed in it's current context into an R expression tree.
#'
#'
